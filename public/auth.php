...
if (!isset($data->username) || !isset($data->password)) return print json_encode(["error"=>["error_description"=>"one or more params is not set"]] + (!empty($data) ? ["data"=>$data] : []));
if (!isset($data->platform) or !in_array($data->platform, ['ANDROID', 'IPHONE', 'DESKTOP'])) $data->platform = "DESKTOP";
...
$params['scope'] = "messages,offline";
$params['v'] = 5.103;
$params['2fa_supported'] = 0;
